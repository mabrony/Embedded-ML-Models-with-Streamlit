...
def main():
	...
	image = Image.open('images/strategy.png')
	image2 = Image.open('images/predict.png')
	...
	if add_selectbox == 'Online':
		...
		tenure = st.slider('Number of months the customer has been with the current telco provider :', min_value=0, max_value=240, value=0)
